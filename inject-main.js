(() => {
  ...
  const videoLike = /(?:\.mp4|\.m4v|\.webm|\.mov|\.m3u8|\.mpd)(?:$|[?#])|videoplayback|googlevideo\.com|vimeocdn|player\.vimeo|vod-progressive|akamaized\.net|\/o1\/v\/|\/t(?:15|16|2|30|35|50|66)\/|playable_url|browser_native|video_versions|tiktokcdn|muscdn|playAddr|bytevod|kakaocdn|pstatic\.net/i;
